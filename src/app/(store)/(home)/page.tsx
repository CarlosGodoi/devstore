...
export default async function Home() {
  ...
  return (
    <div className="grid max-h-[835px] grid-cols-9 grid-rows-6 gap-6">
      <Link
      ...
      >
        ...
        />
        <div
          className="absolute bottom-28 right-20 h-12 flex items-center gap-2 max-w-[280px] rounded-full border-2
